...
def configInCtoSE3(Tce_standoff,Tce_grip,Tsc_initial):
...
def TrajectoryGenerator():
    ...
    Tse_standoffInit,Tse_gripInit = configInCtoSE3(Tce_standoff,Tce_grip,Tsc_initial)
    ...
    for i in range(0,len(traj_states)):
